...
If you want to use your own bucket, you need to specify so in circle.yml and create an AWS IAM User with the policy mentioned in policy.txt (and give CircleCI access to it).
